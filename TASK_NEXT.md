...
Phase hiện tại: **chưa mở** — Phase 17 (RAG Local LLM, dự kiến).

Mục tiêu tiếp theo: chưa lập checklist. Xem mô tả dự kiến trong `ROADMAP.md` mục **Phase 17 - RAG Local LLM**.

Điều kiện mở Phase 17:
- Cập nhật `ROADMAP.md` với checklist mục tiêu chi tiết (đánh giá GPU/RAM on-prem, Docker service, runbook).
- Thay nội dung `TASK_NEXT.md` bằng checklist Phase 17.
...
Ghi chú: chỉ mở sau Phase 16; cần đánh giá GPU/RAM on-prem, Docker service mới và runbook vận hành — **không** cloud API.
